...
public class AnimaniaBlocks {
    ...
    public static final Supplier<LiquidBlock> SLOP_BLOCK = registerBlock("slop_block", SlopBlock::new, BlockBehaviour.Properties.of().strength(100.0F).replaceable().liquid().pushReaction(PushReaction.DESTROY).noLootTable());
